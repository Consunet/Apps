...
const chromium = require('../../common/node_modules/selenium-webdriver/chrome');
...
describe('EveryPass Specific Testing', function () {
    ...
    before(async function () {
        ...
        chromeOptions.setUserPreferences({"download.default_directory":__dirname + path.sep + "test_downloads"});
